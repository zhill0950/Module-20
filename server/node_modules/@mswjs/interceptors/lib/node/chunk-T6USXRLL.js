...
var _ClientRequestInterceptor = class extends _chunkAABH3XLQjs.Interceptor {
  constructor() {
    ...
    this.onRequest = async ({
      ...
      const isRequestHandled = await _chunkW46RNDIEjs.handleRequest.call(void 0, {
        request,
        requestId,
        controller,
    ...
    this.onResponse = async ({
      ...
      return _chunkW46RNDIEjs.emitAsync.call(void 0, this.emitter, "response", {
        requestId,
        request,
        response,
        isMockedResponse
...
//# sourceMappingURL=chunk-T6USXRLL.js.map